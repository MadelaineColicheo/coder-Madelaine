...
urlpatterns = [
    ...
    path('logout/', LogoutView.as_view(template_name='core/logout.html'), name='logout'),    path('productos/', views.productos, name='productos'),  # URL para la vista de productos
